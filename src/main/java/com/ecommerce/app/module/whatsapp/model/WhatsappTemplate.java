...
public class WhatsappTemplate {
    ...
    public WhatsappTemplate(Long id, Users customer, String temptitle, WhatsappMsgType whatsappType, String message, String createdBy, LocalDateTime created, String modifiedBy, LocalDateTime modified) {
        this.id = id;
