...
public class WhatsappTemplateController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("list", whatsappTemplateRepository.findAll(sort));
        return "whatsapp/admin/smstemplate_index";
    }
    ...
    public String add(Model model, WhatsappTemplate whatsappTemplate) {
        ...
        return "whatsapp/admin/add_smstemplate";
    }
    ...
    public String create(Model model, @Valid WhatsappTemplate whatsappTemplate,
        ...
        return "redirect:/whatsapptemplate/index";
    }
