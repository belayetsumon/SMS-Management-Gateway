 ...
 */
@Controller
@RequestMapping("/whatsapppriceplan")
public class WhatsappPricePlanController {
    ...
    public String index(Model model) {
        ...
        return "whatsapp/admin/plan_index";
    }
    ...
    public String add(Model model, WhatsappPricePlan whatsappPricePlan) {
        ...
        return "whatsapp/admin/add_plan";
    }
    ...
    public String create(Model model, @Valid WhatsappPricePlan whatsappPricePlan,
        ...
        return "redirect:/whatsapppriceplan/index";
    }
