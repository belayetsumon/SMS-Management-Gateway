 ...
 */
@Controller
@RequestMapping("/gatewaycustomer")
public class GatewayCustomerController {
    ...
    public String index(Model model) {
        ...
        return "sms/customers/gateway_index";
    }

    @RequestMapping(value = {"/add"})
    public String add(Model model, Gateway gateway) {
        return "sms/customers/add_gateway";
    }

    @RequestMapping("/save")
    public String create(Model model, @Valid Gateway gateway, BindingResult bindingResult,
        ...
        return "redirect:/gatewaycustomer/index";
    }
